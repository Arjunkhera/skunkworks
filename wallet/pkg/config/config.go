...
func GetConfig() *root.Config {
	return &root.Config{
		...
		Server: &root.ServerConfig{
			...
			SkynetIP: envOrDefaultString("skynet:server:port", "http://192.168.191.242:8080"),
			ChainIP:  envOrDefaultString("chain:server:port", "http://192.168.191.238:8091/IdentityChain")},
